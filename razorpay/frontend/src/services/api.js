...
export const updateProduct = (id, data) => api.patch(`/admin/product/${id}`, data);
...
export const addToCart = (productId) => api.post(`/user/addToCart/${productId}`);
export const removeFromCart = (productId) => api.post(`/user/removeToCart/${productId}`);
